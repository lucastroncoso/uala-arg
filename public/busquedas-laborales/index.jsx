...
//                     {Object.entries(parseData).map(department => {
//                         return <div>
//                             <h2 className="title-2">{department[0]}</h2>
//                             <div className="grid md:grid-cols-3 py-12">
//                                 {department[1].carrers.map(position => {
//                                     return <a href={"/busquedas-laborales/" + position.uid} className="bg-white px-8 py-4 m-3 flex flex-col border-gray-5' rounded-2xl shadow-blue justify-between	">
