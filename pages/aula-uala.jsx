                ...
                <div className="flex justify-center items-center lg:order-none order-1 col-span-2 lg:col-span-1">
                  <div className="lg:px-24">
                    ...
                    <p className="text-2xl text-gray-150 ">
                      Nuestro espacio de educación financiera. ¡Hablamos de finanzas, pero fácil!
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="col-span-10 col-start-2 grid grid-cols-2 gap-8 mt-12">
                ...
                >
                  ...
                  <div className="lg:col-span-8 col-span-12 flex items-center flex-wrap lg:pl-8">
                    ...
                    <p className="text-xl text-gray-150 text-center lg:text-left">
                      Escribimos sobre finanzas, emprendedurismo y más. <br />
                ...
                >
                  ...
                  >
                    ...
                    <p className="text-xl text-gray-150 text-center lg:text-left">
                      Visitamos virtualmente escuelas de nivel secundario. <br /> ¡Anotá la tuya!
                    </p>
                  </div>
                </a>
              </div>
                ...
                <div className="flex justify-center items-center">
                  <div className="lg:px-12">
                    ...
                    <p className="text-xl text-gray-150  lg:pr-24 pb-8 px-4 lg:px-0">
                      Bajate nuestro programa completo donde encontrarás todo en un mismo documento.
                    </p>
                    <a
                      target="_blank"
                ...
                <div>
                  <div className=" my-12">
                    <img
                      ...
                      src="/assets/images/aula/Aula Ualá_3.png"
                      alt=""
                    />
                  </div>
                </div>
              ...
              <div className="col-span-10 col-start-2 grid lg:grid-cols-2 grid-cols-1">
                <div className="col-span-2 lg:col-span-1">
                  <div className=" my-12">
                    <img
                      className="rounded-xl w-full"
                      src="/assets/images/aula/Aula Ualá_2.png"
                      alt=""
                    />
                  </div>
                </div>
                <div className="flex justify-center items-center col-span-2 lg:col-span-1 z-10">
                  <div className="lg:pr-8 lg:pl-12 w-full">
                    ...
                    <p className="lg:text-2xl text-xl text-gray-150  mb-6 text-center lg:text-left">
                      Suscribite a nuestro <br /> newsletter de educación financiera.
                    </p>
              ...
              <div className="flex justify-center items-center">
                <div className="lg:pr-8 lg:pl-12 w-full">
                  ...
                  <p className="text-xl text-gray-150  mb-6">
                    Aula Ualá es nuestro espacio de educación financiera. Apostamos por la educación
                    porque así generamos un círculo virtuoso que mejora la vida de las personas.
                  </p>
                  <p className="text-xl text-gray-150  mb-6">
                    {' '}
                    En Ualá ofrecemos un producto para manejar tu plata pero mucho más fácil,
                    apostando por la inclusión financiera y educando para que tomes las mejores
                    decisiones.
                  </p>
                  <p className="text-xl text-gray-150 font-semibold">
                    Por cualquier consulta o sugerencia sobre Aula Ualá, escribinos a{' '}
