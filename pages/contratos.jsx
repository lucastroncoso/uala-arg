...
export default function Contratos(props) {
  const charges = [
    ...
    {
      href: '/assets/legales/Oferta Préstamos (2).pdf',
      title: 'Términos y condiciones: Préstamos',
    },
    {
      href: '/assets/legales/Resumen condiciones préstamo (2).pdf',
      title: 'Resumen condiciones: Préstamos',
    },
    {
      href: '/assets/legales/Oferta Cuotificaciones (1).pdf',
      title: 'Términos y condiciones: Cuotificaciones',
    },
    {
      href: '/assets/legales/Resumen condiciones cuotificaciones (1).pdf',
      title: 'Resumen condiciones: Cuotificaciones',
    },
    {
      href: '/assets/legales/TyCUalaBis.pdf',
      title: 'Términos y condiciones:',
      title2: 'Ualá Bis',
    },
    {
      href: 'https://www.ualamas.com.ar/legales/Uala-mas_terminos-y-condiciones.pdf',
      title: 'Términos y condiciones:',
      title2: 'Ualá+',
    },
    {
              ...
              {charges.map((charge) => (
                <div className="bg-white px-8 py-4 m-3 flex flex-col border-gray-5' rounded-2xl shadow-lightblue  justify-between	">
                  ...
                  <a
                    target="_blank"
                    href={charge.href}
                    className="link cursor-pointer  text-gray-600 "
                  >
                    Leer
                  </a>
                </div>
