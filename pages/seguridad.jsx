    ...
    <>
      <Layout nav footer>
        <Hero
          ...
          img={<Image src="/assets/images/seguridad/Mask Group (28).webp" width={1365} height={1050} />}
        />
        <Container className=" bg-red-degrade  md:py-36 py-20 text-gray-250">
          <SecurityCard title="Seguridad de tus claves"
            ...
            <div>
              <p>Las claves que usás para operar en Ualá son datos confidenciales. Nunca las compartas con nadie, incluso si parece que te las pide Ualá. Tampoco muestres los números que están atrás de la tarjeta.</p>
              <p>Cuando crees o modifiques tus claves, evitá usar información personal que pueda ser fácil de adivinar (fecha de nacimiento, número de documento u otra información similar).</p>
          ...
          <SecurityCard title="Seguridad de tu dispositivo"
            ...
            <div>
              ...
              <p>Nunca instales aplicaciones por fuera de Play Store o App Store, no se pueden garantizar que sean legítimas.</p>
            </div>
          </SecurityCard>
          <SecurityCard title="Seguridad en tus operaciones"
            ...
            <div>
              ...
              <p>Cuando compres online, verificá que la dirección de la página web sea legítima y que se trate de un sitio seguro.</p>
