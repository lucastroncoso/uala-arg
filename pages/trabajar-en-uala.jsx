          ...
          <div className="grid lg:mb-8 lg:mt-24 md:mb-0 mt-20 mb-12 md:grid-cols-2 md:mt-40">
            <div className="flex flex-wrap md:col-span-1 content-center mb-12 md:order-none order-1 md:mt-0 mt-8">
              ...
              <div className="w-full mt-4 md:mt-6">
                <div className="md:w-6/6 md:mr-6 text-base md:text-lg leading-8 text-gray-150">
                  En Ualá somos un equipo de profesionales innovadores y comprometidos que viene a
                  revolucionar el sistema financiero, para hacerlo abierto y para tod@s. Y lo
            ...
            <div className="flex items-center md:col-span-1 justify-center md:order-none order-2 ">
              <div className="md:ml-6 rounded-3xl overflow-hidden flex md:w-6/6">
                <Image
                  src="/assets/images/trabajar/office/busquedas_laborales_hero.jpg"
                  width={1389}
                  height={1134}
                />
              </div>
...
<br/>En 2020 fuimos reconocidos como una de las mejores empresas para trabajar para las mujeres y para los Millennials."
          ...
          <Container>
            <div className="mt-12 md:mt-20 mb-14 md:mb-28">
              <div className="text-center font-medium text-4xl text-gray-250">
              ...
              <div className="mt-4 flex justify-center">
                <button className="hover:bg-blue-250 text-blue-250 hover:text-white rounded-full border border-blue-250 text-blue-uala py-3 px-8 text-center bg-blue-trabajar-button">
                  <a target="_blank" href="/sumate">
                    Ver búsquedas laborales
                  </a>
                </button>
              </div>
            </div>
