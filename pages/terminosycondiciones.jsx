            ...
            <Layout nav footer>
                ...
                <Container className="mt-24 md:mt-36 mb-20">
                    ...
                    <div className="text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">1. OBJETO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">2. COMUNICACIONES</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">3. MEDIOS DE UTILIZACIÓN</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">4. REQUISITOS PARA LA UTILIZACIÓN DE LA APP</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">5. TRANSFERENCIAS DE FONDOS ENVIADOS DESDE Y HACIA CUENTAS DE PAGO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">6. VALIDEZ</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">7. FECHA DE LAS OPERACIONES</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">8. CÓDIGO DE RESPUESTA RÁPIDA (QR)</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">9. RESPONSABILIDAD POR LOS FONDOS</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">10. IRREVOCABILIDAD</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">11. PRUEBA DE LAS OPERACIONES</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">12. INCUMPLIMIENTOS DEL USUARIO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">13. MEDIDAS EN CASO DE INCUMPLIMIENTO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">14. CONFIDENCIALIDAD</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">15. PROPIEDAD INTELECTUAL E INDUSTRIAL</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">16. PROVEEDOR DE SERVICIOS DE PAGO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">17. RESPONSABILIDADES</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">18. PRIVACIDAD Y PROTECCIÓN DE LOS DATOS PERSONALES</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">19. VÍNCULOS A SITIOS DE TERCEROS</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">20. COSTO DE LOS SERVICIOS</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">21. MODIFICACIÓN DE LOS SERVICIOS</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">22. MODIFICACIÓN DE LOS TÉRMINOS Y CONDICIONES</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">23. RESCISIÓN DEL SERVICIO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">24. CESIÓN O USO COMERCIAL NO AUTORIZADO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">25. TOTALIDAD DEL ACUERDO</h3>
                        <p className="mb-2 text-justify">
                        ...
                        <h3 className="text-blue-250 font-bold mt-8">27. DOMICILIO. LEY APLICABLE. COMPETENCIA</h3>
                        <p className="mb-2 text-justify">
