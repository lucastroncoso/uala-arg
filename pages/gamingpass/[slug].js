      ...
      <Layout nav footer banner>
        <Container className="mx-auto lg:w-10/12 mb-72 mt-40">
          ...
          <div className="flex flex-row justify-between">
            <div className="md:w-8/12">
              ...
              <div className="w-full mt-4">
                <div className="md:w-9/12 subtitle-1 ">{promotion.description}</div>
              </div>
            </div>

            <div className="w-4/12 hidden md:block ml-4">
              <Image
          ...
          <div className=" mt-8 flex flex-row flex-wrap">
            <div className="w-1/3 p">{promotion.date}</div>

            <div className="w-2/3 p ">
              <i className="fas fa-map-marker-alt mx-2 text-blue-250"></i>
              {!!promotion &&
                promotion.locationsCollection.items.map((loc) => {
            ...
            {promotion.callToAction && (
              ...
              >
                <OutlinedButton href={promotion.actionUrl} text={promotion.actionText} />
              </div>
            )}
          </div>
          ...
          <div className="w-full mt-20 mb-2">
            ...
            <p className="p text-justify break-words">
              <small>{promotion.conditions}</small>
            </p>
          </div>
        </Container>
      </Layout>
