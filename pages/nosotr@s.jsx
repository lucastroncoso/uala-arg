    ...
    <div ref={sectionRef}>
      ...
      <Layout nav footer>
        <Hero
          ...
          img={
            <Image src="/assets/images/nosotros/oficinas-nica-2.jpg" width={1389} height={1134} />
          }
        />
     ...
     <ImageItemsSection
          ...
          img={
            <Image src="/assets/images/nosotros/oficinas-pasillo.jpg" width={1389} height={1134} />
          }
        />
            ...
            <div className="grid md:grid-cols-2 md:gap-16 ">
              <ol>
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">
                    Queremos que manejes toda tu plata desde una app: fácil, gratis y segura.
                  </li>
                </div>
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">Queremos que compres lo que quieras, donde quieras.</li>
                </div>
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">
                ...
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">
                    Queremos que recibas el mejor soporte, por redes sociales, Comunidad, mail o
                    chat en vivo.
                  </li>
                </div>
              </ol>
              <ol>
                ...
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">
                    Queremos ser esa generación que creció en el 2001 y que trabaja para que nunca
                    se repita.
                  </li>
                </div>
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">
                    Queremos que te sumes, para construir el futuro con vos – cuantos más seamos,
                    mejor.
                  </li>
                </div>
                <div className="flex flex-nowrap pb-4">
                  <i className="fas fa-chevron-right text-blue-50 pt-2 pr-2"></i>
                  <li className=" text">
                    Queremos estar siempre que nos necesites, empezando por mi.
                  </li>
                </div>
                <li className="pt-6 md:pl-48 text ">
                  <span className="font-semibold">Pierpaolo Barbieri</span> <br /> Fundador y CEO de
                  Ualá
                </li>
              </ol>
            </div>
        ...
        <Container className="pt-64 pb-24 -mt-44  md:bg-blue-350">
          ...
          <h3 className="subtitle-2 text-center">
            Tenemos 5 pilares que nos guían en cada una de las decisiones que tomamos:
          </h3>
