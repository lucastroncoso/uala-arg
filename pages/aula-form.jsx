                ...
                <div className="grid grid-cols-12 w-screen pt-12 my-16">
                    <div className="col-span-10 col-start-2 grid grid-cols-2 ">
                        <div className="col-span-2 lg:pr-72">
                            <h1 className="text-gray-250 text-4xl py-8 pt-12 lg:pt-0 ">Charlas en escuelas de manera online</h1>
                            <h2 className="text-gray-150 text-xl pb-8">Visitamos escuelas de nivel secundario de manera virtual. Les contamos qué 
                            <br />es Ualá y por qué es importante la educación financiera en América Latina.
                            </h2>
                            <h2 className="text-gray-150 text-xl lg:pb-12">Si sos docente o directivo y querés coordinar una charla online,
                        ...
                        <form onSubmit={registerUser} className="col-span-2 grid grid-cols-2 lg:gap-12 gap-0 mt-8 lg:mt-0" id="form">
                            <div className="col-span-2 lg:col-span-1 lg:pr-6">
                                <div className="flex-wrap my-2 ">
                                    <label for="nombre" className="block w-full mb-2 text-xl text-gray-250">Tu nombre y apellido</label>
                                ...
                                <div className="flex-wrap my-2">
                                    <label for="mail" className="block w-full mb-2 text-xl text-gray-250">Mail</label>
                                    <input required="required" type="text" placeholder="arodriguez@gmail.com"
                                        className="w-full p-3 mx-auto mb-6 lg:text-xl text-lg border border-gray-400 rounded-full outline-none"
                                        name="mail" disabled={ !inputsEnabled }></input>
                                </div>
                                <div className="flex-wrap my-2">
                                    <label for="telefono" className="block w-full mb-2 text-xl text-gray-250">Teléfono de contacto</label>
                                    <input required="required" type="text" placeholder="12345678"
                                        className="w-full p-3 mx-auto mb-6 lg:text-xl text-lg border border-gray-400 rounded-full outline-none"
                                        name="telefono" disabled={ !inputsEnabled }></input>
                                </div>
                                <div className="flex-wrap my-2 ">
                                    <label for="rol" className="block w-full mb-2 text-xl text-gray-250">¿Cuál es tu rol en el establecimiento
                        educativo?</label>
                                    ...
                                    <label for="si" className="lg:mr-20 mr-4 text-lg text-gray-150 ">Soy docente</label>
                                    ...
                                    <label for="no" className="text-lg text-gray-150">Soy directivo</label>
                                </div>
                                <div className="flex-wrap my-2">
                                    <label for="espacio" className="block w-full mb-2 text-xl text-gray-250">¿En qué espacio se brindará la
                        charla?</label>
                                ...
                                <div className="flex-wrap my-2">
                                    <label for="nivel" className="block w-full mb-2 text-xl text-gray-250">¿A qué nivel educativo estará
                        dirigida?</label>
                            ...
                            <div className="col-span-2 lg:col-span-1 lg:pr-6">
                                <div className="flex-wrap my-2">
                                    <label for="establecimiento" className="block w-full mb-2 text-xl text-gray-250">Nombre del
                                    establecimiento
                        educativo</label>
                                ...
                                <div className="flex-wrap my-2">
                                    <label for="localidad" className="block w-full mb-2 text-xl text-gray-250">Provincia y localidad en donde
                                    está
                        ubicado</label>
                                ...
                                <div className="flex-wrap my-2">
                                    <label for="web" className="block w-full mb-2 text-xl text-gray-250">Sitio web del establecimiento
                                    educativo
                        (opcional)</label>
                                    <input type="text" placeholder="www.laescuela.com.ar"
                                        className="w-full p-3 mx-auto mb-6 lg:text-xl text-lg border border-gray-400 rounded-full outline-none"
                                        name="web" disabled={ !inputsEnabled }></input>
                                    <label for="conocido" className="block w-full mb-2 text-xl text-gray-250">¿Conocés alguna persona que
                                    trabaje en Ualá? <br /> <span className="text-lg text-gray-150">De ser así, dejanos su nombre y
                            apellido</span></label>
                                ...
                                <div className="flex-wrap my-2 lg:mb-0 ">
                                    <label for="comentario" className="block w-full mb-4 text-xl text-gray-250">¿Querés dejarnos algún
